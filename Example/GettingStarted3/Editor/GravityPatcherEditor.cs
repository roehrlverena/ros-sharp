...
[CustomEditor(typeof(GravityPatcher))]
public class GravityPatcherEditor : Editor
{
    private GravityPatcher gravityPatcher;
    ...
    {
        gravityPatcher = (GravityPatcher)target;
        DrawDefaultInspector();

        if (GUILayout.Button(gravityButtonLabel))
        {
            if (useGravity)
            {
                useGravity = false;
